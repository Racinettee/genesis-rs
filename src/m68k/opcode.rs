...
pub static OP_CODES: &[OpCode] = &[
    ...
    OpCode{name: "asrb", size: 2, opcode: one(0o160000),	mask: one(0170770), args: "QdDs", arch: arch::M68000UP},
    OpCode{name: "asrb", size: 2, opcode: one(0o160040),	mask: one(0170770), args: "DdDs", arch: arch::M68000UP},
    OpCode{name: "asrw", size: 2, opcode: one(0o160100),	mask: one(0170770), args: "QdDs", arch: arch::M68000UP},
    OpCode{name: "asrw", size: 2, opcode: one(0o160140),	mask: one(0170770), args: "DdDs", arch: arch::M68000UP},
    OpCode{name: "asrw", size: 2, opcode: one(0o160300),	mask: one(0177700), args: "~s",   arch: arch::M68000UP},
    OpCode{name: "asrl", size: 2, opcode: one(0o160200),	mask: one(0170770), args: "QdDs", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "asrl", size: 2, opcode: one(0o160240),	mask: one(0170770), args: "DdDs", arch: arch::M68000UP | arch::MCFISA_A},

    OpCode{name: "bhiw", size: 2, opcode: one(0o061000),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "blsw", size: 2, opcode: one(0o061400),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bccw", size: 2, opcode: one(0o062000),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bcsw", size: 2, opcode: one(0o062400),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bnew", size: 2, opcode: one(0o063000),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "beqw", size: 2, opcode: one(0o063400),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bvcw", size: 2, opcode: one(0o064000),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bvsw", size: 2, opcode: one(0o064400),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bplw", size: 2, opcode: one(0o065000),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bmiw", size: 2, opcode: one(0o065400),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bgew", size: 2, opcode: one(0o066000),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bltw", size: 2, opcode: one(0o066400),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bgtw", size: 2, opcode: one(0o067000),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "blew", size: 2, opcode: one(0o067400),	mask: one(0177777), args: "BW", arch: arch::M68000UP | arch::MCFISA_A},

    OpCode{name: "bhil", size: 2, opcode: one(0o061377),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "blsl", size: 2, opcode: one(0o061777),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bccl", size: 2, opcode: one(0o062377),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bcsl", size: 2, opcode: one(0o062777),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bnel", size: 2, opcode: one(0o063377),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "beql", size: 2, opcode: one(0o063777),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bvcl", size: 2, opcode: one(0o064377),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bvsl", size: 2, opcode: one(0o064777),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bpll", size: 2, opcode: one(0o065377),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bmil", size: 2, opcode: one(0o065777),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bgel", size: 2, opcode: one(0o066377),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bltl", size: 2, opcode: one(0o066777),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "bgtl", size: 2, opcode: one(0o067377),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},
    OpCode{name: "blel", size: 2, opcode: one(0o067777),	mask: one(0177777), args: "BL", arch: arch::M68020UP | arch::CPU32 | arch::FIDO_A | arch::MCFISA_B | arch::MCFISA_C},

    OpCode{name: "bhis", size: 2, opcode: one(0o061000),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "blss", size: 2, opcode: one(0o061400),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bccs", size: 2, opcode: one(0o062000),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bcss", size: 2, opcode: one(0o062400),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bnes", size: 2, opcode: one(0o063000),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "beqs", size: 2, opcode: one(0o063400),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bvcs", size: 2, opcode: one(0o064000),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bvss", size: 2, opcode: one(0o064400),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bpls", size: 2, opcode: one(0o065000),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bmis", size: 2, opcode: one(0o065400),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bges", size: 2, opcode: one(0o066000),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "blts", size: 2, opcode: one(0o066400),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bgts", size: 2, opcode: one(0o067000),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bles", size: 2, opcode: one(0o067400),	mask: one(0177400), args: "BB", arch: arch::M68000UP | arch::MCFISA_A},

    OpCode{name: "jhi", size: 2, opcode: one(0o061000),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jls", size: 2, opcode: one(0o061400),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jcc", size: 2, opcode: one(0o062000),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jcs", size: 2, opcode: one(0o062400),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jne", size: 2, opcode: one(0o063000),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jeq", size: 2, opcode: one(0o063400),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jvc", size: 2, opcode: one(0o064000),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jvs", size: 2, opcode: one(0o064400),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jpl", size: 2, opcode: one(0o065000),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jmi", size: 2, opcode: one(0o065400),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jge", size: 2, opcode: one(0o066000),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jlt", size: 2, opcode: one(0o066400),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jgt", size: 2, opcode: one(0o067000),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "jle", size: 2, opcode: one(0o067400),	mask: one(0177400), args: "Bg", arch: arch::M68000UP | arch::MCFISA_A},

    OpCode{name: "bchg", size: 2, opcode: one(0o000500),	mask: one(0170700), args: "Dd$s", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bchg", size: 4, opcode: one(0o004100),	mask: one(0177700), args: "#b$s", arch: arch::M68000UP},
    OpCode{name: "bchg", size: 4, opcode: one(0o004100),	mask: one(0177700), args: "#bqs", arch: arch::MCFISA_A},

    OpCode{name: "bclr", size: 2, opcode: one(0o000600),	mask: one(0170700), args: "Dd$s", arch: arch::M68000UP | arch::MCFISA_A},
    OpCode{name: "bclr", size: 4, opcode: one(0o004200),	mask: one(0177700), args: "#b$s", arch: arch::M68000UP},
    OpCode{name: "bclr", size: 4, opcode: one(0o004200),	mask: one(0177700), args: "#bqs", arch: arch::MCFISA_A},

    OpCode{name: "bfchg", size: 4, opcode: two(0o165300, 0), mask: two(0177700, 0170000), args: "?sO2O3",  arch: arch::M68020UP},
    OpCode{name: "bfclr", size: 4, opcode: two(0o166300, 0), mask: two(0177700, 0170000), args: "?sO2O3",   arch: arch::M68020UP},
    OpCode{name: "bfexts", size: 4, opcode: two(0o165700, 0), mask: two(0177700, 0100000), args: "/sO2O3D1", arch: arch::M68020UP},
    OpCode{name: "bfextu", size: 4, opcode: two(0o164700, 0), mask: two(0177700, 0100000), args: "/sO2O3D1", arch: arch::M68020UP},
    OpCode{name: "bfffo", size: 4, opcode: two(0o166700, 0), mask: two(0177700, 0100000), args: "/sO2O3D1", arch: arch::M68020UP},
    OpCode{name: "bfins", size: 4, opcode: two(0o167700, 0), mask: two(0177700, 0100000), args: "D1?sO2O3", arch: arch::M68020UP},
    OpCode{name: "bfset", size: 4, opcode: two(0o167300, 0), mask: two(0177700, 0170000), args: "?sO2O3",   arch: arch::M68020UP},
    OpCode{name: "bftst", size: 4, opcode: two(0o164300, 0), mask: two(0177700, 0170000), args: "/sO2O3",   arch: arch::M68020UP},
